try:
    ...
    print(f"Error writing example.txt: {e}")
...
try:
    ...
    print(f"Error writing data1.txt: {e}")
...
try:
    ...
    print(f"Error writing data2.txt: {e}")
...
try:
    ...
    print(f"Error writing output.txt: {e}")
...
for n in nums:
    ...
    if n.isdigit():
        ...
        print(f"Warning: '{n}' is not a valid number, skipping")
...
try:
    ...
    print(f"Error writing squares.txt: {e}")
